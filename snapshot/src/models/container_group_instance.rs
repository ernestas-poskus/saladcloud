...
pub struct ContainerGroupInstance {
    ...
    #[serde(rename = "memory_usage_percent", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ssh_host_key_fingerprint", skip_serializing_if = "Option::is_none")]
...
impl ContainerGroupInstance {
    ...
    pub fn new(id: uuid::Uuid, machine_id: uuid::Uuid, state: models::ContainerGroupInstanceState, update_time: time::OffsetDateTime, version: i32) -> ContainerGroupInstance {
