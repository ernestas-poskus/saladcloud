...
impl ContainerGroupProbeHttp {
    ...
    pub fn new(headers: Vec<models::ContainerGroupProbeHttpHeader>, path: String, port: i32, scheme: Option<models::ContainerProbeHttpScheme>) -> ContainerGroupProbeHttp {
