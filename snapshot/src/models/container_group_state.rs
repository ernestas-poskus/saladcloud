...
impl ContainerGroupState {
    ...
    pub fn new(finish_time: time::OffsetDateTime, instance_status_counts: models::ContainerGroupInstanceStatusCount, start_time: time::OffsetDateTime, status: models::ContainerGroupStatus) -> ContainerGroupState {
        ContainerGroupState {
            description: None,
            finish_time,
