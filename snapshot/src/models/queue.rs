...
pub struct Queue {
    ...
    #[serde(rename = "current_queue_length", skip_serializing_if = "Option::is_none")]
...
impl Queue {
    /// Represents a queue.
    pub fn new(container_groups: Vec<models::ContainerGroup>, create_time: time::OffsetDateTime, display_name: String, id: uuid::Uuid, name: String, update_time: time::OffsetDateTime) -> Queue {
        Queue {
            container_groups,
            create_time,
