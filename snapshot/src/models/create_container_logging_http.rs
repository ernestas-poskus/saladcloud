...
impl CreateContainerLoggingHttp {
    ...
    pub fn new(compression: models::ContainerLoggingHttpCompression, format: models::ContainerLoggingHttpFormat, host: String, port: i32) -> CreateContainerLoggingHttp {
