...
pub struct ContainerLoggingHttp {
...
impl ContainerLoggingHttp {
    /// Configuration for sending container logs to an HTTP endpoint. Defines how logs are formatted, compressed, and transmitted.
    pub fn new(compression: models::ContainerLoggingHttpCompression, format: models::ContainerLoggingHttpFormat, headers: Option<Vec<models::ContainerLoggingHttpHeader>>, host: String, port: i32) -> ContainerLoggingHttp {
