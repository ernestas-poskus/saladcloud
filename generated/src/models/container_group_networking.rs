...
impl ContainerGroupNetworking {
    ...
    pub fn new(
        auth: bool,
        dns: String,
        load_balancer: models::ContainerGroupNetworkingLoadBalancer,
        port: i32,
        protocol: models::ContainerNetworkingProtocol,
