...
pub async fn create_container_group(
    ...
    project_name: &str,
    container_group_prototype: models::ContainerGroupPrototype,
) -> Result<models::ContainerGroup, Error<CreateContainerGroupError>> {
...
pub async fn delete_container_group(
...
) -> Result<(), Error<DeleteContainerGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    ...
    let uri_str = format!(
        ...
        organization_name = crate::apis::urlencode(p_path_organization_name),
        project_name = crate::apis::urlencode(p_path_project_name),
        container_group_name = crate::apis::urlencode(p_path_container_group_name)
    );
    let mut req_builder = configuration
        .client
...
pub async fn get_container_group(
    ...
    project_name: &str,
    container_group_name: &str,
) -> Result<models::ContainerGroup, Error<GetContainerGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn get_container_group_instance(
    configuration: &configuration::Configuration,
    organization_name: &str,
    project_name: &str,
    container_group_name: &str,
    container_group_instance_id: &str,
) -> Result<models::ContainerGroupInstance, Error<GetContainerGroupInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
    ...
    let uri_str = format!(
        ...
        project_name = crate::apis::urlencode(p_path_project_name),
        container_group_name = crate::apis::urlencode(p_path_container_group_name),
        container_group_instance_id = crate::apis::urlencode(p_path_container_group_instance_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_container_group_instances(
    ...
    project_name: &str,
    container_group_name: &str,
) -> Result<models::ContainerGroupInstanceCollection, Error<ListContainerGroupInstancesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn list_container_groups(
    ...
    organization_name: &str,
    project_name: &str,
) -> Result<models::ContainerGroupCollection, Error<ListContainerGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
...
pub async fn reallocate_container_group_instance(
    configuration: &configuration::Configuration,
    organization_name: &str,
    project_name: &str,
    container_group_name: &str,
    container_group_instance_id: &str,
) -> Result<(), Error<ReallocateContainerGroupInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn recreate_container_group_instance(
    configuration: &configuration::Configuration,
    organization_name: &str,
    project_name: &str,
    container_group_name: &str,
    container_group_instance_id: &str,
) -> Result<(), Error<RecreateContainerGroupInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn restart_container_group_instance(
    configuration: &configuration::Configuration,
    organization_name: &str,
    project_name: &str,
    container_group_name: &str,
    container_group_instance_id: &str,
) -> Result<(), Error<RestartContainerGroupInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn start_container_group(
    ...
    project_name: &str,
    container_group_name: &str,
) -> Result<(), Error<StartContainerGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn stop_container_group(
    ...
    project_name: &str,
    container_group_name: &str,
) -> Result<(), Error<StopContainerGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn update_container_group(
    ...
    project_name: &str,
    container_group_name: &str,
    container_group_patch: models::ContainerGroupPatch,
) -> Result<models::ContainerGroup, Error<UpdateContainerGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
...
pub async fn update_container_group_instance(
    configuration: &configuration::Configuration,
    organization_name: &str,
    project_name: &str,
    container_group_name: &str,
    container_group_instance_id: &str,
    container_group_instance_patch: models::ContainerGroupInstancePatch,
) -> Result<models::ContainerGroupInstance, Error<UpdateContainerGroupInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_name = organization_name;
    let p_path_project_name = project_name;
    let p_path_container_group_name = container_group_name;
